                ...
                <div class="col-12">
                    <div class="card"> 
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="<?=base_url()?>/musers/employee/resource" method="POST">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control  <?= ($data['validation']->hasError('name_employee')) ? 'is-invalid' :'' ?>" placeholder="Nama Lengkap" value="<?=old('name_employee')?>"  name="name_employee">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group has-icon-left ">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control <?= ($data['validation']->hasError('number_employee')) ? 'is-invalid' :'' ?>" placeholder="+62 Number" value="<?=old('number_employee')?>"  name="number_employee">
                                                        <div class="form-control-icon pb-1 mb-1">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control <?= ($data['validation']->hasError('jabatan_employee')) ? 'is-invalid' :'' ?>" placeholder="Jabatan (Pegawai)" value="<?=old('jabatan_employee')?>"  name="jabatan_employee">
                                                        <div class="form-control-icon pb-1 mb-1">
                                                        ...
                                                        <select name="pengguna_employee" class="form-select  <?= ($data['validation']->hasError('pengguna_employee')) ? 'is-invalid' :'' ?>">
                                                            ...
                                                            <?php foreach ($data['get_user'] as $value) : ?> 
                                                                <?php  if ($value->name_users != "admin") : ?>
                                                                    <option value="<?=$value->id?>" <?= (old('pengguna_employee') == $value->id) ? 'selected' : '' ?> > &raquo; <?=$value->name_users?></option>
                                                                <?php endif; ?>
                                                            <?php endforeach;?>
                                                        </select> 
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label>Alamat</label> 
                                                <textarea name="alamat_employee" id="" class="form-control <?= ($data['validation']->hasError('alamat_employee')) ? 'is-invalid' :'' ?>" cols="10" rows="4" placeholder="Alamat Lengkap"><?=old('alamat_employee')?></textarea>
                                                <small class="text-danger text-capitalize">  
